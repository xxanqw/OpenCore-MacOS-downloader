...
if answer == str('1'): print(title + '\nDownloading ' + Lion), p(1), cmd("py macrecovery.py -b Mac-C3EC7CD22292981F -m 00000000000F0HM00 download", shell=True)
elif answer == str('2'): print(title + '\nDownloading ' + MLion), p(1), cmd("py macrecovery.py -b Mac-7DF2A3B5E5D671ED -m 00000000000F65100 download", shell=True)
elif answer == str('3'): print(title + '\nDownloading ' + Mvr), p(1), cmd("py macrecovery.py -b Mac-F60DEB81FF30ACF6 -m 00000000000FNN100 download", shell=True)
elif answer == str('4'): print(title + '\nDownloading ' + Ysmt), p(1), cmd("py macrecovery.py -b Mac-E43C1C25D4880AD6 -m 00000000000GDVW00 download", shell=True)
elif answer == str('5'): print(title + '\nDownloading ' + ElC), p(1), cmd("py macrecovery.py -b Mac-FFE5EF870D7BA81A -m 00000000000GQRX00 download", shell=True)
elif answer == str('6'): print(title + '\nDownloading ' + Sierra), p(1), cmd("py macrecovery.py -b Mac-77F17D7DA9285301 -m 00000000000J0DX00 download", shell=True)
elif answer == str('7'): print(title + '\nDownloading ' + HSierra), p(1), cmd("py macrecovery.py -b Mac-BE088AF8C5EB4FA2 -m 00000000000J80300 download", shell=True)
elif answer == str('8'): print(title + '\nDownloading ' + Mojave), p(1), cmd("py macrecovery.py -b Mac-7BA5B2DFE22DDD8C -m 00000000000KXPG00 download", shell=True)
elif answer == str('9'): print(title + '\nDownloading ' + Catalina), p(1), cmd("py macrecovery.py -b Mac-00BE6ED71E35EB86 -m 00000000000000000 download", shell=True)
elif answer == str('10'): print(title + '\nDownloading ' + BS), p(1), cmd("py3 macrecovery.py -b Mac-2BD1B31983FE1663 -m 00000000000000000 download", shell=True)
elif answer == str('11'): print(title + '\nDownloading ' + Monterey), p(1), cmd("py macrecovery.py -b Mac-E43C1C25D4880AD6 -m 00000000000000000 download", shell=True)
elif answer == str('L'): print(title + '\nDownloading ' + LTST), p(1), cmd("py macrecovery.py -b Mac-E43C1C25D4880AD6 -m 00000000000000000 -os latest download", shell=True)
